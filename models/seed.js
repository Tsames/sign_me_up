...
mongoose.connection.on("open", () => {
  ...
  User.findOne({ username: "tom" }, (err, tom) => {
    ...
    const exampleEvents = [
      ...
      { name: "Big snowball fight", description: "We're having a big snowball fight on campus, be there or miss out on the biggest even of second semester", image: "http://www.pxleyes.com/blog/wp-content/uploads/winter-sports/49.jpg", date: dateSix, address: "Downtown Sunnyvale", state: "CA", city: "Sunnyvale", zip: 12345, attendees: [], organizer: tom._id },
      { name: "Steve's bar crawl", description: "Steve didn't have a proper bachelor party, so were throwing him a belated bar crawl party!", image: "https://cdn.vox-cdn.com/thumbor/jWqYcdf9sbEcANA8G02rJFWOEYI=/0x74:960x614/1600x900/cdn.vox-cdn.com/uploads/chorus_image/image/49155101/nickelandryeFB.0.0.0.jpg", date: dateSix, address: "Downtown Sunnyvale", state: "CA", city: "Sunnyvale", zip: 12345, attendees: [], organizer: tom._id },
    ]
